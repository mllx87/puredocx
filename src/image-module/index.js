...
function getInnerPptx(_ref2) {
  ...
  var xmlDoc = str2xml("<xml>" + xmlString + "</xml>");
...
var ImageModule = function () {
  function ImageModule(options) {
    ...
    this.tagsXmlLexedArray = ["p:pic", "p:cNvPr", "pic:pic", "pic:cNvPr"];
  ...
  _createClass(ImageModule, [{
    ...
    value: function optionsTransformer(options, docxtemplater) {
      ...
      this.fileTypeConfig.tagsXmlLexedArray = DocUtils.concatArrays([this.fileTypeConfig.tagsXmlLexedArray, this.tagsXmlLexedArray])
      this.fileType = docxtemplater.fileType;
      this.zip = docxtemplater.zip;
      this.delimiters = docxtemplater.delimiters
      options.xmlFileNames = options.xmlFileNames.concat(relsFiles);
      options.fileTypeConfig = this.fileTypeConfig
  ...
  },
  {
    ...
    value: function render(part, options) {
      ...
      var sizePixel = this.options.getSize(imgBuffer, tagValue, part.value, part);
    ...
    value: function getRenderedPart(part, rId, sizePixel) {
      ...
      //console.log("getRenderedPart=>",newText)
